...
<ul id="nav">
	...
	<li class="top"><a href="#nogo2" class="top_link"><span class="down" id="brand-ico"><img height="17px" src=".\img\logo-<? echo $fpk_brand; ?>.png" style="padding-top:2px;"></span></a>
		<ul class="sub tabs">
			...
			?>
			<li id="SetupModels"><a href="#nogo23" id="SetupModels">Модели автомобилей</a></li>';
...
<div id="indented" class="box"> 
        <ul class="tabs"> 
        	...
        	<li>
                <a id="journal_t" href="#"><img src="img/1test-drive.png" class="left-ico-1" style="opacity:0.3">Журнал тестдрайва</a> 
            </li> 
  ...
  <div id="footer">
    ...
    <div class="title" style="float:left;padding-left:10px;font-size:12px;padding-top:5px;"></div> 
      <div class="roundfooter" id="r5" id3="tst" title="Тестдрайвы" style="margin-right:20px"></div>
