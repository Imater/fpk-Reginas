...
month = "0" + month;
  ...
  if (n==1)
   window.onmousemove = function ()
      ...
      setTimeout( function() { jsClearAlerts(); }, 2000 );
  ...
  clearInterval(si2);
  si2=setInterval(jsSmsCup,4*60*1000);		
...
function jsSms()
{
 alldate = $('#datediv').html();
  ...
  clearInterval(si);
  si=setInterval(jsSms,4*60*1000);		
...
//////////////////////////////////////////////////////////////////////////
    ...
    //Подготовка чата
	jsChatRefresh();
    jsSetInterval(7000); //Запуск чата
...
//		alert($(this).attr('cantopen'));
	...
	$(".clientformmini").unbind('click').click(function(){
                    ...
                    vvv = $(this).parent('.accordion').children('.clientform').children('#finder');
