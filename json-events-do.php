...
if ($version==3)
  {
    $manager='%';
    $sqlnews="SELECT *,1_clients.id clientid,1_clients.manager manager, 1_do.id id, 1_do.checked chk FROM `1_do` JOIN 1_clients ON 1_clients.id = 1_do.client WHERE 1_clients.brand = '".$fpk_brand."' AND 1_do.type='Тест-драйв'";
