...
/* Turn an input field into an entry point for a date and/or time value.
   ...
   $('input selector').datetimeEntry(
      {spinnerImage: 'css/image/spinnerSquare.png', spinnerSize: [20, 20, 0]}); */
...
function DatetimeEntry() {
	...
	this._defaults = {
		...
		spinnerImage: 'css/image/spinnerDefault.png', // The URL of the images to use for the date spinner
