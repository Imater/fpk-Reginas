...
if( $admin!="" )
   ...
   if ($HTTP_GET_VARS['AddClient']==2) $d=AddDo($sql->maxid,'Звонок',$did,$admin,$Manager);
   if ($HTTP_GET_VARS['AddClient']==3) $d=AddDo($sql->maxid,'Визит',$did,$admin,$Manager);
   if ($HTTP_GET_VARS['AddClient']==6) { $d=AddDo($sql->maxid,'Тест-драйв',$did,$admin,$Manager); $d=AddDo($sql->maxid,'Визит',1,$admin,$Manager); }
